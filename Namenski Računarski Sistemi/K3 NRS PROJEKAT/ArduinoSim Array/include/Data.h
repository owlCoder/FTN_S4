...
class Data
{
    ...
    public:
        ...
        void resetujSlog();
        void azurirajDatumUSlogu(const string);
        void azurirajDatumUSlogu();
        void azurirajVremeUSlogu(const string);
        void azurirajVremeUSlogu();
        void azurirajBrojUSlogu(const int);
        ...
        string getSlogDatum() const;
        string getSlogVreme() const;
        int getSlogBroj() const;
        char *serijalizacijaSloga();
        bool operator == (const Data& d) const { return generisaniSlog.vreme == d.generisaniSlog.vreme && generisaniSlog.broj == d.generisaniSlog.broj; }
